...
export interface IAuthClient {
    ...
    register(cmd: CreateapplicationUserCommand): Observable<ApplicationUserDto>;
}
...
export class AuthClient implements IAuthClient {
    ...
    protected processRegister(response: HttpResponseBase): Observable<ApplicationUserDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ApplicationUserLoginQuery implements IApplicationUserLoginQuery {
    email?: string | undefined;
    password?: string | undefined;

    constructor(data?: IApplicationUserLoginQuery) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ApplicationUserLoginQuery {
        data = typeof data === 'object' ? data : {};
        let result = new ApplicationUserLoginQuery();
        result.init(data);
        return result;
    }
...
export interface IApplicationUserLoginQuery {
    email?: string | undefined;
    password?: string | undefined;
}
